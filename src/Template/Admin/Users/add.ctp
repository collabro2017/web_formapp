<div class="card">
    ...
    <div class="card-body card-block">
        ...
        <div class="row form-group">
            ...
            <?= $this->Form->control('password', ['label' => false, 'class' => 'form-control', 'placeholder' => __('Enter password')]); ?>
        </div>
        ...
        <div class="row form-group">
            ...
            <!-- <div class="col-12 col-md-9">
                <select name="role" data-placeholder="Choose a Role..." class="standardSelect" tabindex="1">
                    <option value=""></option>
                    <option value="admin">Admin</option>
                    <option value="supervisor">Supervisor</option>
                    <option value="leadhand">Lead Hand</option>
                </select>
            </div> -->
