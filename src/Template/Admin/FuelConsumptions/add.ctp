...
<div class="card">
    <?= $this->Form->create($fuelConsumption, ['class' => 'form-horizontal']) ?>
    ...
    <div class="card-body card-block">
        ...
        <div class="row form-group">
            ...
            <?= $this->Form->control('consumption_date', ['label' => false, 'class' => 'form-control', 'placeholder' => __('Enter consumption date'), 'type' => 'text']); ?>
        </div>
